        ...
        <div className="Wrapper">
          <AppBar
            style={{
              ...
              borderBottom: "3px solid rgb(0, 188, 212)",
              position: "absolute"
            }}
          ...
          <div className="footer">
            ...
            <div className="SocialButtons">
              <a
                ...
                target="_blank"
                href="https://www.facebook.com/rasmus.arvidsson1"
              >
                <FacebookIcon />
              </a>
              <a
                ...
                rel="noopener noreferrer"
                target="_blank"
                href="https://mail.google.com/mail/?view=cm&fs=1&to=rasmus.arvidsson1@gmail.com&su=SUBJECT&body=BODY&bcc="
              >
                <EmailIcon />
              </a>
              ...
              <a
                without
                rel="noopener noreferrer"
                href="https://www.linkedin.com/in/rasmus-arvidsson/"
                target="_blank"
              >
                <LinkedinIcon />
              </a>
              <a
                without
                rel="noopener noreferrer"
                href="https://github.com/railerbailer/"
                target="_blank"
              >
                <GithubIcon />
              </a>
            ...
            <div>Rasmus Arvidsson&copy;2019</div>
